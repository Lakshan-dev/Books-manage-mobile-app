...
class _bookViewState extends State<bookView> {
  ...
  getMethod()async{
    var theUrl = Uri.parse('http://uvalms.ru.com/mobile_app/allbooks.php');
                              ...
                              children: <Widget>[
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5,),
                                    Text('Quantity: ${snapshot.data[index]['quantity']}',style: GoogleFonts.openSans(
                                    fontSize: 8,
                                    fontWeight: FontWeight.w400,
                                    color: Color.fromARGB(255, 44, 44, 44),
                                  ),),
  ...
  _searchBook() async{
    ...
    var phpUrl = Uri.parse("http://uvalms.ru.com/mobile_app/searchBook.php");
  ...
  Widget bookData(data) => Container(
    padding: EdgeInsets.all(16),
    child: Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        Title(color: Colors.black, child: Text('Book Details')),
        ListBody(
          children: <Widget>[
            Text('ID: ${data["id"]}'),
            Text('Name: ${data["name"]}'),
